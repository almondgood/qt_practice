...
QT_MOC_LITERAL(8, 80, 16), // "updateLeddataSig"
QT_MOC_LITERAL(9, 97, 5), // "start"
QT_MOC_LITERAL(10, 103, 5), // "pause"
QT_MOC_LITERAL(11, 109, 12) // "readGpioData"

    },
    "TetrixBoard\0scoreChanged\0\0score\0"
    "levelChanged\0level\0linesRemovedChanged\0"
    "numLines\0updateLeddataSig\0start\0pause\0"
    "readGpioData"
};
...
void TetrixBoard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->updateLeddataSig((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->start(); break;
        case 5: _t->pause(); break;
        case 6: _t->readGpioData((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (TetrixBoard::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TetrixBoard::updateLeddataSig)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void TetrixBoard::updateLeddataSig(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
