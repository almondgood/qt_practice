...
#include <memory>
#include "../SensorMan_jwt/tab3controlpannel.h"
...
QT_MOC_LITERAL(1, 18, 17), // "socketSendDataSig"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 13), // "lampOnOffSlot"
QT_MOC_LITERAL(4, 51, 13), // "plugOnOffSlot"
QT_MOC_LITERAL(5, 65, 16) // "tab3RecvDataSlot"

    },
    "Tab3ControlPannel\0socketSendDataSig\0"
    "\0lampOnOffSlot\0plugOnOffSlot\0"
    "tab3RecvDataSlot"
};
...
void Tab3ControlPannel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->socketSendDataSig((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->lampOnOffSlot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->plugOnOffSlot((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->tab3RecvDataSlot((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Tab3ControlPannel::socketSendDataSig)) {
                *result = 0;
                return;
            }
        }
