...
QT_MOC_LITERAL(1, 13, 13), // "widgetClicked"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 12) // "processClick"

    },
    "CustomWidget\0widgetClicked\0\0processClick"
};
...
void CustomWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->processClick(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CustomWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomWidget::widgetClicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CustomWidget::widgetClicked()
{
