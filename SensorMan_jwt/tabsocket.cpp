#include "tabsocket.h"
#include "ui_tabsocket.h"

TabSocket::TabSocket(QWidget *parent) :
    QWidget(parent),
    ui(new Ui::TabSocket)
{
    ui->setupUi(this);
...
void TabSocket::on_pPBServerConnect_clicked(bool checked)
{
    bool bOk;
    if (checked) {
...
void TabSocket::socketRecvUpdateSlot(QString strRecvData) {
...
void TabSocket::on_pPBSendButton_clicked()
{
...
void TabSocket::on_pPBRecvDataClear_clicked()
{
    ui->pTERecvData->clear();
}

void TabSocket::keyboardSlot() {
