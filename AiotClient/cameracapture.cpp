...
//            cvtColor(frame, frame, COLOR_RGB2BGR);
            ...
            emit sigSocketSendData("[ALLMSG]INTRUDER");
            QThread::msleep(200);
            emit sigSocketSendData("[ALLMSG]GASON");
